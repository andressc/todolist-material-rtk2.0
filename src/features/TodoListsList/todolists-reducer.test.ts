...
test("change EntityStatus TodoList", () => {
    const result: TodolistDomainType[] = todolistReducer(state, changeEntityStatusAC({todoListId: todoList2, entityStatus}))
...
test("change Filter TodoList", () => {
    const result: TodolistDomainType[] = todolistReducer(state, changeFilterTodoListAC({todoListId: todoList1, filter}))
